...
QDRANT_URL=http://localhost:6333`}</Code>
      <ul>
        <li>
          ...
          Column size is configured via <code>EMBEDDING_DIMENSIONS</code> (default <code>1536</code>
          ). Choose the correct dimension before the <code>embeddings</code> table is created — it
          cannot be migrated safely afterward.
        </li>
        <li>
