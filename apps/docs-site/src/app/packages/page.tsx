...
const backendPackages = [
  {
    ...
    name: '@kortex/core',
    summary:
      'Backend runtime — KortexRuntime, interfaces, orchestration. No env wiring or concrete providers.',
  },
  {
    href: '/packages/config',
    name: '@kortex/config',
    summary:
      'Server bootstrap — createKortex(), createKortexFromEnv(), validation, adapter loading.',
  },
];
...
const chatPackages = [
  {
    ...
    name: '@kortex/ui',
    summary:
      'Web chat widget — <Kortex /> for React/Next.js; <kortex-ui> Web Component for other web frameworks.',
  },
  {
    href: '/packages/react-native',
    name: '@kortex/react-native',
    summary:
      'Native chat widget — <Kortex /> for React Native with the same public props where possible.',
  },
];
...
export default function PackagesPage() {
  return (
    <DocPage title="Packages">
      ...
      <ul>
        <li>
          <code>apps/docs-site</code> — documentation + embedded <code>@kortex/ui</code> chat widget
          (run with <code>pnpm docs</code> → <code>http://localhost:3001</code>)
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          <code>import {'{ Kortex }'} from &quot;@kortex/ui&quot;</code>
        </li>
        <li>
        ...
        <li>
          ...
          <code>@kortex/svelte</code> wrapper packages — do not use <code>&lt;Kortex /&gt;</code> in
          those frameworks unless you wrap the React component yourself.
        </li>
      </ul>
