...
export default function CorePackagePage() {
  return (
    <DocPage title="@kortex/core">
      ...
      <ul>
        <li>
          <code>KortexRuntime</code> — main orchestrator
        </li>
        <li>
          <code>AIProvider</code>, <code>MemoryProvider</code>, <code>VectorProvider</code>
        </li>
        <li>
          <code>chat()</code>, <code>stream()</code>, <code>remember()</code>,{' '}
          <code>retrieveContext()</code>
        </li>
        <li>
          <code>ingest()</code>, <code>runTool()</code>, <code>runAgent()</code>
        </li>
      </ul>
