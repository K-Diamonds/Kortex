  ...
  return (
    <DocPage title="Live demo">
      ...
      <p>
        ...
        <Link href="/packages/ui/quickstart">Quick Start</Link> to add it to yours.
      </p>

      <p>
        <Link href="/packages/ui/examples/react">React example</Link> ·{' '}
        <Link href="/packages/ui/install">Installation</Link>
      </p>
    </DocPage>
  );
}
